...
export function SubathonDetails() {
  return (
    <Card className='space-y-6 bg-gradient-to-tl from-purple-50 to-white p-4 shadow-lg lg:p-6 dark:from-gray-800 dark:to-black'>
      ...
      <ol className='tracking-wider= list-outside list-decimal space-y-4 px-6 pb-4 leading-relaxed text-slate-700 marker:text-blue-500 lg:text-lg 2xl:text-xl dark:text-slate-200'>
        <li>
        ...
        <li>
          Finally, I&apos;ve set up a few extra INCENTIVES throughout the subathon to keep me
