          ...
          {socialData.map((icon, idx) => (
            <div key={idx}>
              <a
                ...
                className='inline-flex rounded-full border-transparent bg-white p-2 font-extrabold text-primary shadow-md transition-all duration-200
                ease-in hover:bg-white focus:outline-none 3xl:p-4 dark:bg-slate-800 dark:hover:bg-slate-900'
                style={{
