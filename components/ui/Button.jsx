  ...
  'inline-flex items-center cursor-pointer justify-center appearance-none focus-visible:outline-none focus-visible:ring-0 whitespace-nowrap disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        social:
          'size-8 border-2 border-light-tint bg-w2b font-semibold shadow-soft hover:border-light-fade hover:bg-light hover:text-b2w hover:shadow-hard max-[375px]:size-7 lg:size-10 xl:size-11 2xl:size-12 3xl:size-14 dark:border-gray-fade dark:hover:border-gray-tint dark:hover:bg-dark-fade',
        fun: 'relative overflow-hidden rounded-lg border-2 bg-light-fade text-sm shadow-soft transition-transform duration-500 ease-in-out before:absolute before:inset-0 before:z-[-1] before:translate-x-full before:bg-gradient-to-r before:from-primary-tint before:to-primary-fade before:duration-500 hover:scale-105 hover:shadow-hard hover:before:-translate-x-0 active:scale-100 2xl:text-base 3xl:text-lg dark:bg-dark-fade',
      },
      size: {
        default: 'h-10 px-4',
        sm: 'h-4 px-2 md:h-8 md:px-8 2xl:px-12',
        md: 'h-10 px-12',
        lg: 'h-10 w-full 2xl:h-12 3xl:h-14',
        icon: 'rounded-full',
      },
    },
    defaultVariants: {
