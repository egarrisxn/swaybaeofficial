...
export function Tooltip({children, text, direction = 'top', ...otherProps}) {
  const getTooltipClasses = () => {
    let baseClasses =
      'absolute z-50 opacity-0 pointer-events-none bg-foreground text-background p-1 sm:p-2 overflow-hidden 2xl:text-base min-w-max text-xs 2xl:text-sm rounded-md shadow-md transition-all transform'
...
//     className={cn(
//       'animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 overflow-hidden rounded-md border bg-foreground px-3 py-1.5 text-sm text-background shadow-md 2xl:text-base',
//       className,
//     )}
//     {...props}
//   />
