...
export default function SearchBar({placeholder}) {
  ...
  return (
    <div className='relative'>
      <div className='flex items-center space-x-2 rounded-md border bg-white p-2 dark:bg-black'>
        <label htmlFor='search' className='sr-only'>
          Search
        </label>
        <input
          id='search'
          className='w-40 appearance-none bg-white outline-none sm:w-auto dark:bg-black'
      ...
      {searchResults.length > 0 && (
        <div className='absolute left-0 top-full z-30 mt-1 max-h-60 w-full overflow-y-auto rounded-md border bg-white p-2 text-sm font-semibold tracking-tight dark:bg-black'>
          Results:
