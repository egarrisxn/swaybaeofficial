export default function LoadButton({onClick}) {
  return (
    <div className='flex justify-center pb-12 pt-4'>
      <button
        type='button'
        className='group relative overflow-hidden rounded-lg bg-light-tint px-3 py-3 text-base font-medium leading-tight text-dark-fade shadow-2xl dark:bg-light dark:shadow-secondary'
        onClick={onClick}
      >
