  ...
  return (
    <>
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8'>
        <figure className='transition-all duration-300 ease-in-out hover:shadow-hard'>
        ...
        <section className='flex flex-col gap-4 lg:p-1'>
          ...
          <div className='mt-2 space-y-4 lg:ml-1 lg:mt-4'>
            <Link href={`/blog/post/${post.postSlug}`}>
              <h2 className='scroll-m-20 pb-2 text-3xl font-semibold tracking-tight first:mt-0 3xl:text-4xl'>
                {title}
              </h2>
            </Link>
            <h3 className='line-clamp-3 scroll-m-20 text-xl font-medium tracking-tight text-gray-fade 3xl:text-2xl'>
              {excerpt}
            </h3>
            <Link href={`/blog/post/${post.postSlug}`}>
