      ...
      <section className='mx-auto grid max-w-11xl items-center md:grid-cols-2 md:gap-2 md:rounded-lg md:border-2 md:bg-white md:px-4 md:py-6 md:shadow-soft lg:gap-16 lg:p-12 xl:p-16 2xl:p-20 3xl:p-28'>
        ...
        >
          ...
          <input
            ...
            className='w-full rounded-md border border-dark-fade bg-light-fade px-3 py-2 shadow ring-offset-background file:flex file:border-0 file:bg-transparent file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 xl:px-5 xl:py-3 xl:text-base 3xl:px-8 3xl:py-4 3xl:text-2xl'
            required
          />
          ...
          <textarea
            ...
            onChange={handleInputChange}
            className='flex min-h-[80px] w-full rounded-md border border-dark-fade bg-light-fade px-3 py-2 shadow ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 xl:text-base 3xl:text-2xl'
            required
          />
          <button
